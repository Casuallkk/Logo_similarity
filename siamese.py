...
# from nets.siamese_repvgg import Siamese as siamese
# from nets.siamese import Siamese as siamese


class Siamese(object):
    _defaults = {
        "model_path": 'logs/ep044-loss0.022-val_loss0.190.pth',
    ...
    def generate(self):
        ...
        # pretrained_dict = {k: v for k, v in state_dict.items() if (k in model_dict and 'fully_connect1' not in k)}
    ...
    def detect_image(self, image_1, image_2):
        ...
        if output <= 1:
            ...
            print("error!!!There is a wrong result!")
            return output
